...
namespace SelectionStatments
{
    public static class Statements
    {
        ...
        public static string GetTypeOfIntegerWithSwitchExpression(object arg)
        {
            return arg switch
            {
                sbyte n => $"{arg} is sbyte.",
                byte n => $"{arg} is byte.",
                short n => $"{arg} is short.",
                int n => $"{arg} is int.",
                long n => $"{arg} is long.",
                ushort n => $"{arg} is ushort.",
                uint n => $"{arg} is uint.",
                ulong n => $"{arg} is ulong.",
        ...
        public static byte GetLengthWithSwitchExpression(int number)
        {
            ...
            {
                int i when i > -10 && i < 10 => 1,
                int i when i > -100 && i < 100 => 2,
                int i when i > -1_000 && i < 1_000 => 3,
                int i when i > -10_000 && i < 10_000 => 4,
                int i when i > -100_000 && i < 100_000 => 5,
                int i when i > -1_000_000 && i < 1_000_000 => 6,
                int i when i > -10_000_000 && i < 10_000_000 => 7,
                int i when i > -100_000_000 && i < 100_000_000 => 8,
                int i when i > -1_000_000_000 && i < 1_000_000_000 => 9,
                _ => 10
            };
        }
